            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  MyText(
                    '${config.creditLabel} ${CurrencyFormatter.format(party.given, abbreviate: !showFullAmounts)} · '
                    '${config.debitLabel} ${CurrencyFormatter.format(party.received, abbreviate: !showFullAmounts)}',
                    font: AppFont.sourceSans,
                    size: AppSizes.caption,
                    color: AppColors.textHint,
                    maxLines: 1,
